class Cafetera {
    ...
    //distintos constructores de acuerdo a los valores de los parametros ingresados por el usuario.
    ...
    //Funcion para llenar la cafetera
    ...
    //Funcion para servir una taza, chequea si la cafetera esta vacia, o tiene menos cafe q lo que la taza requiere y da diferentes mensajes.
    ...
    //Funcion que vacia la cafetera
    public vaciarCafetera(): void {
        this.cantidadActual = 0;
        console.log(`Se vacio la cafetera.`);
    }

    //Funcion para agregar una determinada cantidad de cafe, chequea que esa cantidad no sea mayor a la capacidad maxima.
